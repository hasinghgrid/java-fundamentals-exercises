...
public class CrazyGenerics {
     ...
     */
    interface ComparableCollection<E extends BaseEntity> extends Collection<E>, Comparable<Collection<?>> {
        @Override
    ...
    static class CollectionUtil {
         ...
         */
        // Updated: Use getUuid() instead of directly accessing uuid
        ...
        public static <T extends BaseEntity> boolean hasDuplicates(List<T> entities, T targetEntity) {
            return entities.stream()
                    .filter(entity -> entity.getUuid().equals(targetEntity.getUuid())) // Use getter here
                    .count() > 1;
        }
        ...
        // Find Max method (no changes needed)
        ...
        public static <T extends BaseEntity> T findMostRecentlyCreatedEntity(Collection<T> entities) {
            return findMax(entities, (Comparator<T>) CREATED_ON_COMPARATOR)
